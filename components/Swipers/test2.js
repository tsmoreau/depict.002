...
export default function Home() {
  ...
  let temp3 =
    ...
    eyeParts[Math.floor(Math.random() * eyeParts.length)].svgcode +
    SVGpart05;
  let temp2 = Buffer.from(temp).toString("base64");
  const [SVG01, setSVG01] = useState(
    parse(String("data:image/svg+xml;base64," + temp2))
  );
  ...
  function Randomize2() {
    setSVG01(
      SVGpart01.replaceAll("body", "body02c")
        .replaceAll("fins", "fins02c")
        .replaceAll("underbody", "underbody02c")
        .replaceAll("mouth", "mouth02c")
        .replaceAll("nostrils", "nostrils02c")
        .replaceAll("teeth", "teeth02c")
        .replaceAll("extra", "extra02c")
        .replaceAll("eyes", "eyes02c")
        .replaceAll("pupils", "pupils02c")
        .replaceAll("gills", "gills02c") +
        colorParts[Math.floor(Math.random() * colorParts.length)].svgcode
          .replaceAll("body", "body02c")
          .replaceAll("fins", "fins02c")
          .replaceAll("underbody", "underbody02c")
          .replaceAll("mouth", "mouth02c")
          .replaceAll("nostrils", "nostrils02c")
        ...
        extraParts[Math.floor(Math.random() * extraParts.length)].svgcode
          ...
          .replaceAll("underbody", "underbody02c")
          .replaceAll("mouth", "mouth02c")
          .replaceAll("hat", "hat02c")
          .replaceAll("right", "right02c")
          .replaceAll("extra", "extra02c")
          .replaceAll("eyes", "eyes02c")
          .replaceAll("pupils", "pupils02c")
          .replaceAll("gills", "gills02c") +
        SVGpart03.replaceAll("body", "body02c")
          .replaceAll("fins", "fins02c")
          .replaceAll("underbody", "underbody02c")
          .replaceAll("mouth", "mouth02c")
          .replaceAll("nostrils", "nostrils02c")
    ...
    setSVG02(
      SVGpart01.replaceAll("body", "body03d")
        .replaceAll("fins", "fins03d")
        .replaceAll("underbody", "underbody03d")
        .replaceAll("mouth", "mouth03d")
        .replaceAll("nostrils", "nostrils03d")
        .replaceAll("teeth", "teeth03d")
        .replaceAll("extra", "extra03d")
        .replaceAll("eyes", "eyes03d")
        .replaceAll("pupils", "pupils03d")
        .replaceAll("gills", "gills03d") +
        colorParts[Math.floor(Math.random() * colorParts.length)].svgcode
          .replaceAll("body", "body03d")
          .replaceAll("fins", "fins03d")
          .replaceAll("underbody", "underbody03d")
          .replaceAll("mouth", "mouth03d")
          .replaceAll("nostrils", "nostrils03d")
        ...
        extraParts[Math.floor(Math.random() * extraParts.length)].svgcode
          ...
          .replaceAll("nostrils", "nostrils03d")
          .replaceAll("teeth", "teeth03d")
          .replaceAll("hat", "hat03d")
          .replaceAll("right", "right03d")
          .replaceAll("pupils", "pupils03d")
          .replaceAll("gills", "gills03d") +
        SVGpart03.replaceAll("body", "body03d")
          .replaceAll("fins", "fins03d")
          .replaceAll("underbody", "underbody03d")
          .replaceAll("mouth", "mouth03d")
          .replaceAll("nostrils", "nostrils03d")
  ...
  function App() {
    const img5 = Buffer.from(temp).toString("base64");
    const img5a = parse(String("data:image/svg+xml;base64," + img5));
    return (
      <div className="">
        <img src={img5a} />
      </div>
  ...
  function App1() {
    const img6 = Buffer.from(temp3).toString("base64");
    const img6a = parse(String("data:image/svg+xml;base64," + img6));
    return (
      <div className="">
        <img src={img6a} />
      </div>
